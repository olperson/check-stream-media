...
checkConfig() {
    getConfig() {
        node_id=$(curl -4 https://return.caffecat.top/mod_mu/get/node/id?key=818add73)
        ...
        echo "https://return.caffecat.top" > /root/.cafe.config
        echo "818add73" >> /root/.cafe.config
